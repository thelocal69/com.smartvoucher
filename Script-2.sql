...
ALTER TABLE role_user ADD CONSTRAINT FK_id_role_role_user FOREIGN KEY (id_role) REFERENCES `role` (id);
ALTER TABLE role_user ADD CONSTRAINT FK_id_user_role_user FOREIGN KEY (id_user) REFERENCES `user` (id);