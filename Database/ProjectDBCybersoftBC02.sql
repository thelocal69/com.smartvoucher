...
VALUES
    ...
    ('W03', 1, 'Giảm 10% tối đa 100% khi mua vé máy bay, khách sạn', 'Mỗi voucher chỉ được sử dụng 01 lần. Không áp dụng cho Combo. Không được tách hoặc cộng gộp hóa đơn.', 'http://localhost:8082/warehouse/thumbnail_travel.png', 'http://localhost:8082/warehouse/banner_travel.png', 11.000, 2, 0.1, 100.000, '2023-03-01 12:00:00', '2024-03-10 12:00:00', 1, 1, 200, 1, 1, 'Admin', '2023-03-01 12:00:00'),
    ...
    ('W14', 1, 'Giảm 50.000đ thẻ nạp Game', 'Mỗi voucher chỉ được sử dụng 01 lần. Không áp dụng cho Combo. Không được tách hoặc cộng gộp hóa đơn.', 'http://localhost:8082/warehouse/thumbnail_game.png', 'http://localhost:8082/warehouse/banner_culow.png', 20.000, 1, 50.000, 50.000, '2023-02-01 23:00:00', '2024-02-10 23:00:00', 1, 1, 750, 1, 10, 'Admin', '2024-02-01 23:00:00'),
